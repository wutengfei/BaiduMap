...
import cn.busmap.MyApplication;
...
public class BusLineOverlay extends OverlayManager {
    ...
    public boolean onBusStationClick(int index) {
        if (mBusLineResult.getStations() != null
            ...
            System.out.println(mBusLineResult.getStations().get(index).getTitle());//获取点击的站点名称
            Toast.makeText(MyApplication.getContext(), mBusLineResult.getStations().get(index).getTitle(),
