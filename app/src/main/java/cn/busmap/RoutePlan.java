...
import cn.busmap.overlayutil.MassTransitRouteOverlay;
import cn.busmap.overlayutil.OverlayManager;
import cn.busmap.overlayutil.TransitRouteOverlay;
...
public class RoutePlan extends Activity implements BaiduMap.OnMapClickListener,
    ...
    public void searchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withCityNameAndPlaceName("北京", startLoc);
        PlanNode enNode = PlanNode.withCityNameAndPlaceName("北京", endLoc);
